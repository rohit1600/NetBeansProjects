...
public class PITplayer0 implements MessageListener {
            ...
            if (message instanceof ObjectMessage) {
                ...
                if (o instanceof Reset) {
                    ...
                    if (marker_sender1 == 3) {
                        ...
                        System.out.println("In Player0, got second marker from " + marker.source);
                        sendSnapShot(state);
                        return;
                    }
    ...
    private void sendSnapShot(HashMap<String, Integer> state) throws Exception {
        System.out.println("SNAPSHOT IN PLAYER 0 IS " + state.toString());
        ...
        marker_recd = false;
        markers_sent = 0;
        System.out.println("THESE ARE THE END VALUES***********" + "MARKER SENDER1 IS " + marker_sender1 + "MARKER RECD IS " + marker_recd);
    }
}